...
function HeroBanner() {
  return (
    <Box sx={{
        ...
        <Typography fontWeight={700} sx={{fontSize: { lg: '44px', xs: '40px'}}} mb={3} mt={3}>
            Sweet, Smile <br/> and Repeat
        </Typography>
        <Typography fontSize="22px" lineHeight="35px" mb={3}>
            Chekout the most effective exercises.
        </Typography>
        ...
        <img src={HeroBannerImage} alt="baner" className="hero-banner-img"/>
